 ...
 */
 ...
 #define BCM2835_SMI_CS           0
 #define BCM2835_SMI_LENGTH       1
 #define BCM2835_SMI_ADRS         2
 #define BCM2835_SMI_DATA         3
 #define BCM2835_SMI_READ0        4
 #define BCM2835_SMI_WRITE0       5
 #define BCM2835_SMI_READ1        6
 #define BCM2835_SMI_WRITE1       7
 #define BCM2835_SMI_READ2        8
 #define BCM2835_SMI_WRITE2       9
 #define BCM2835_SMI_READ3       10
 #define BCM2835_SMI_WRITE3      11
 #define BCM2835_SMI_DMAC        12
 #define BCM2835_SMI_DIRCS       13
 #define BCM2835_SMI_DIRADDR     14
 #define BCM2835_SMI_DIRDATA     15
 /* Register masks for SMI_READ and SMI_WRITE */
 #define BCM2835_SMI_RW_WIDTH_MSK        0xC0000000
 #define BCM2835_SMI_RW_WID8             0x00000000
 #define BCM2835_SMI_RW_WID16            0x40000000
 #define BCM2835_SMI_RW_WID18            0x80000000
 #define BCM2835_SMI_RW_WID9             0xC0000000
 #define BCM2835_SMI_RW_SETUP_MSK        0x3F000000
 #define BCM2835_SMI_RW_SETUP_LS         24
 #define BCM2835_SMI_RW_MODE68           0x00800000
 #define BCM2835_SMI_RW_MODE80           0x00000000
 #define BCM2835_SMI_READ_FSETUP         0x00400000
 #define BCM2835_SMI_WRITE_SWAP          0x00400000
 #define BCM2835_SMI_RW_HOLD_MSK         0x003F0000
 #define BCM2835_SMI_RW_HOLD_LS          16
 #define BCM2835_SMI_RW_PACEALL          0x00008000
 #define BCM2835_SMI_RW_PACE_MSK         0x00007F00
 #define BCM2835_SMI_RW_PACE_LS          8
 #define BCM2835_SMI_RW_DREQ             0x00000080
 #define BCM2835_SMI_RW_STROBE_MSK       0x0000007F
 #define BCM2835_SMI_RW_STROBE_LS        0
 /* Registers masks for Direct Access control register */
 #define BCM2835_SMI_DIRCS_ENABLE        0x00000001
 #define BCM2835_SMI_DIRCS_START         0x00000002
 #define BCM2835_SMI_DIRCS_DONE          0x00000004
 #define BCM2835_SMI_DIRCS_WRITE         0x00000008
 /* Registers masks for Direct Access address register */
 #define BCM2835_SMI_DIRADRS_DEV_MSK     0x00000300
 #define BCM2835_SMI_DIRADRS_DEV_LS      8
 #define BCM2835_SMI_DIRADRS_DEV0        0x00000000
 #define BCM2835_SMI_DIRADRS_DEV1        0x00000100
 #define BCM2835_SMI_DIRADRS_DEV2        0x00000200
 #define BCM2835_SMI_DIRADRS_DEV3        0x00000300
 #define BCM2835_SMI_DIRADRS_MSK         0x0000003F
 #define BCM2835_SMI_DIRADRS_LS          0
